...
cardPhoto:
  {
    'src': '../images/rails-private-events/home.jpg',
...
carouselPhotos:
  [
    ...
    {
      'src': '../images/rails-private-events/sign-up.jpg',
      'altText': 'A form asking the user to enter their name and a button to sign the user up.',
      'caption': 'Signup page',
    },
    {
      'src': '../images/rails-private-events/sign-up-confirmation.jpg',
